...
/****** Object:  Database [QLBH]    ******/ 
CREATE DATABASE [QLBH01]  
ON PRIMARY  
( NAME = 'QuanlyBH', FILENAME = 'D:\cosodulieu\QLYBANHANG01\QLBH1.mdf' , SIZE = 4048KB , MAXSIZE = 
10240KB , FILEGROWTH = 20%) 
 LOG ON  
( NAME = 'QLBH_log', FILENAME = 'D:\cosodulieu\QLYBANHANG01\QLBH_log1.ldf' , SIZE = 1024KB , MAXSIZE = 
...
GO
ALTER TABLE [dbo].[KhachHang] ADD [DCMail] [nvarchar](50) NULL
go
ALTER TABLE [dbo].[KhachHang] ADD [DiemTL] [int] NULL
go
...
GO 
ALTER TABLE [dbo].[KhachHang] WITH CHECK ADD CONSTRAINT [kh_ck2] CHECK (([DiemTL]>=(0)
))
GO 
...
GO
ALTER TABLE [dbo].[HoaDon]   
ADD CONSTRAINT CK_HoaDon_NgayGiao  
